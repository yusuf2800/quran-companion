...
const surah_ayahs = [
  ...
  55, 78, 96, 29, 22, 24, 13, 14, 11, 11, 18, 12, 12, 30, 52, 31, 43, 28, 9, 20,
  56, 40, 31, 50, 78, 46, 37, 29, 19, 34, 25, 22, 20, 11, 8, 30, 20, 15, 11, 8,
  8, 8, 19, 5, 8, 8, 11, 11, 8, 3, 9, 5, 3, 7, 3, 6, 3, 6, 4,
];

export const rukus1 = ['', 5, 4, 3, 3]

export const eng_names = [
  "",
  "Al-Fatiha",
  "Al-Baqarah",
  "Al-Imran",
...
for (let i = 1; i < 31; i++) {
  juzs.push({ juz: i, name: juz_names[i], ayah: juz_ayahs[i] });
}
