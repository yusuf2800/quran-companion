...
var H5AudioPlayer = function (_Component) {
  ...
  function H5AudioPlayer() {
    ...
    _defineProperty(_assertThisInitialized(_this), "lastVolume", (_this$props$volume = _this.props.volume) !== null && _this$props$volume !== void 0 ? _this$props$volume : 1);
    ...
    _defineProperty(_assertThisInitialized(_this), "renderUIModule", function (comp, key) {
      var _this$props3 = _this.props,
          ...
          customAdditionalControls = _this$props3$customAd === void 0 ? [RHAP_UI.LOOP] : _this$props3$customAd,
          _this$props3$customVo = _this$props3.customVolumeControls,
          customVolumeControls = _this$props3$customVo === void 0 ? [RHAP_UI.VOLUME] : _this$props3$customVo,
  ...
  _createClass(H5AudioPlayer, [{
    ...
    value: function render() {
      var _this$props5 = this.props,
          ...
          customProgressBarSection = _this$props5$customPr === void 0 ? [RHAP_UI.CURRENT_TIME, RHAP_UI.PROGRESS_BAR, RHAP_UI.DURATION] : _this$props5$customPr,
          _this$props5$customCo = _this$props5.customControlsSection,
          customControlsSection = _this$props5$customCo === void 0 ? [RHAP_UI.ADDITIONAL_CONTROLS, RHAP_UI.MAIN_CONTROLS, RHAP_UI.VOLUME_CONTROLS] : _this$props5$customCo,
...
_defineProperty(H5AudioPlayer, "defaultI18nAriaLabels", {
  player: 'Audio player',
