...
var H5AudioPlayer = function (_Component) {
  ...
  function H5AudioPlayer() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "lastVolume", (_this$props$volume = _this.props.volume) !== null && _this$props$volume !== void 0 ? _this$props$volume : 1);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleKeyDown", function (e) {
      var _this$props$hasDefaul;

      if ((_this$props$hasDefaul = _this.props.hasDefaultKeyBindings) !== null && _this$props$hasDefaul !== void 0 ? _this$props$hasDefaul : true) {
        switch (e.key) {
          case ' ':
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderUIModule", function (comp, key) {
      var _this$props3 = _this.props,
          _this$props3$defaultC = _this$props3.defaultCurrentTime,
          defaultCurrentTime = _this$props3$defaultC === void 0 ? '--:--' : _this$props3$defaultC,
          _this$props3$progress = _this$props3.progressUpdateInterval,
          progressUpdateInterval = _this$props3$progress === void 0 ? 20 : _this$props3$progress,
          _this$props3$showDown = _this$props3.showDownloadProgress,
          showDownloadProgress = _this$props3$showDown === void 0 ? true : _this$props3$showDown,
          _this$props3$showFill = _this$props3.showFilledProgress,
          showFilledProgress = _this$props3$showFill === void 0 ? true : _this$props3$showFill,
          _this$props3$showFill2 = _this$props3.showFilledVolume,
          showFilledVolume = _this$props3$showFill2 === void 0 ? false : _this$props3$showFill2,
          _this$props3$defaultD = _this$props3.defaultDuration,
          defaultDuration = _this$props3$defaultD === void 0 ? '--:--' : _this$props3$defaultD,
          _this$props3$customIc = _this$props3.customIcons,
          customIcons = _this$props3$customIc === void 0 ? {} : _this$props3$customIc,
          _this$props3$showSkip = _this$props3.showSkipControls,
          showSkipControls = _this$props3$showSkip === void 0 ? false : _this$props3$showSkip,
          ...
          _this$props3$showJump = _this$props3.showJumpControls,
          showJumpControls = _this$props3$showJump === void 0 ? true : _this$props3$showJump,
          _this$props3$customAd = _this$props3.customAdditionalControls,
          customAdditionalControls = _this$props3$customAd === void 0 ? [_constants.RHAP_UI.LOOP] : _this$props3$customAd,
          _this$props3$customVo = _this$props3.customVolumeControls,
          customVolumeControls = _this$props3$customVo === void 0 ? [_constants.RHAP_UI.VOLUME] : _this$props3$customVo,
          _this$props3$muted = _this$props3.muted,
          muted = _this$props3$muted === void 0 ? false : _this$props3$muted,
          _this$props3$timeForm = _this$props3.timeFormat,
          timeFormat = _this$props3$timeForm === void 0 ? 'auto' : _this$props3$timeForm,
          _this$props3$volume = _this$props3.volume,
          volumeProp = _this$props3$volume === void 0 ? 1 : _this$props3$volume,
          _this$props3$loop = _this$props3.loop,
          loopProp = _this$props3$loop === void 0 ? false : _this$props3$loop,
          mse = _this$props3.mse,
          _this$props3$i18nAria = _this$props3.i18nAriaLabels,
          i18nAriaLabels = _this$props3$i18nAria === void 0 ? H5AudioPlayer.defaultI18nAriaLabels : _this$props3$i18nAria;
  ...
  (0, _createClass2.default)(H5AudioPlayer, [{
    ...
    value: function render() {
      var _this$props5 = this.props,
          ...
          _this$props5$loop = _this$props5.loop,
          loopProp = _this$props5$loop === void 0 ? false : _this$props5$loop,
          _this$props5$preload = _this$props5.preload,
          preload = _this$props5$preload === void 0 ? 'auto' : _this$props5$preload,
          _this$props5$autoPlay = _this$props5.autoPlay,
          autoPlay = _this$props5$autoPlay === void 0 ? false : _this$props5$autoPlay,
          ...
          layout = _this$props5$layout === void 0 ? 'stacked' : _this$props5$layout,
          _this$props5$customPr = _this$props5.customProgressBarSection,
          customProgressBarSection = _this$props5$customPr === void 0 ? [_constants.RHAP_UI.CURRENT_TIME, _constants.RHAP_UI.PROGRESS_BAR, _constants.RHAP_UI.DURATION] : _this$props5$customPr,
          _this$props5$customCo = _this$props5.customControlsSection,
          customControlsSection = _this$props5$customCo === void 0 ? [_constants.RHAP_UI.ADDITIONAL_CONTROLS, _constants.RHAP_UI.MAIN_CONTROLS, _constants.RHAP_UI.VOLUME_CONTROLS] : _this$props5$customCo,
          children = _this$props5.children,
          style = _this$props5.style,
          _this$props5$i18nAria = _this$props5.i18nAriaLabels,
          i18nAriaLabels = _this$props5$i18nAria === void 0 ? H5AudioPlayer.defaultI18nAriaLabels : _this$props5$i18nAria;
...
(0, _defineProperty2.default)(H5AudioPlayer, "defaultI18nAriaLabels", {
  player: 'Audio player',
