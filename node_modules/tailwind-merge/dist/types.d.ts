...
declare const getDefaultConfig: () => {
    ...
    readonly classGroups: {
        ...
        readonly 'bg-position': readonly [{
            readonly bg: readonly ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top", (value: string) => boolean, (value: string) => boolean];
        }];
        /**
         * Background Repeat
        ...
        readonly 'inset-shadow': readonly [{
            readonly 'inset-shadow': readonly ["none", (value: string) => boolean, (value: string) => boolean, ThemeGetter];
        }];
        /**
        ...
        readonly 'perspective-origin': readonly [{
            readonly 'perspective-origin': readonly ["center", "top", "top-right", "right", "bottom-right", "bottom", "bottom-left", "left", "top-left", (value: string) => boolean, (value: string) => boolean];
        }];
        /**
         * Rotate
        ...
        readonly 'transform-origin': readonly [{
            readonly origin: readonly ["center", "top", "top-right", "right", "bottom-right", "bottom", "bottom-left", "left", "top-left", (value: string) => boolean, (value: string) => boolean];
        }];
        /**
         * Transform Style
    ...
    readonly orderSensitiveModifiers: ["before", "after", "placeholder", "file", "marker", "selection", "first-line", "first-letter", "backdrop", "*", "**"];
};
